(function (root, factory) {
  ...
  (function (window, document, Chartist) {
    ...
    function foreignObject(content, attributes, className, insertFirst) {
      ...
      // http://www.w3.org/TR/SVG/extend.phpForeignObjectElement)
      var fnObj = this.elem(
        "foreignObject",
        attributes,
        className,
    ...
    /**
     * The animate function lets you animate the current element with SMIL animations. You can add animations for multiple attributes at the same time by using an animation definition object. This object should contain SMIL animation attributes. Please refer to http://www.w3.org/TR/SVG/animate.phpfor a detailed specification about the available animation attributes. Additionally an easing property can be passed in the animation definition object. This can be a string with a name of an easing function in `Chartist.Svg.Easing` or an array with four numbers specifying a cubic Bézier curve.
