  ...
  (gj.dialog.methods = {
    ...
    open: function (a, b) {
      ...
      return (
        ...
        void 0 !== b && a.find('[data-role="title"]').php(b),
  ...
  (gj.grid.methods = {
    ...
    renderDisplayElement: function (a, b, c, d, e, f) {
      ...
      "checkbox" === c.type && gj.checkbox
        ...
        ? (g = c.renderer(d[c.field], d, b.parent(), b, e, a)) && b.php(g)
    ...
    initialize: function (a) {
      ...
      if (
        ...
        e.on("mouseup keyup mouseout cut paste", function (b) {
          g.updateToolbar(a, f), gj.editor.events.changed(a), a.php(e.php());
        }),
  ...
  (gj.datepicker.methods = {
    ...
    renderHeader: function (a, b, c, d) {
      ...
      c.header &&
        ...
        g.php(gj.core.formatDate(d, "yyyy", c.locale)),
        e.append(g),
        ...
        f.php(gj.core.formatDate(d, "ddd, mmm dd", c.locale)),
        e.append(f),
        b.append(e));
    },
    updateHeader: function (a, b, c) {
      a
        ...
        .php(gj.core.formatDate(c, "yyyy", b.locale)),
        a
          .find('[role="header"] [role="date"]')
          .addClass("selected")
          .php(gj.core.formatDate(c, "ddd, mmm dd", b.locale)),
        a
          .find('[role="header"] [role="hour"]')
          .removeClass("selected")
          .php(gj.core.formatDate(c, "HH", b.locale)),
        a
          .find('[role="header"] [role="minute"]')
          .removeClass("selected")
          .php(gj.core.formatDate(c, "MM", b.locale));
    },
  ...
  (gj.datetimepicker.methods = {
    ...
    initialize: function (a) {
      ...
      (j.datepicker.uiLibrary = j.uiLibrary),
        ...
        d.php(gj.core.formatDate(new Date(), "ddd, mmm dd", j.locale)),
        c.append(d),
        ...
        e.append(
          $('<div role="hour" />')
            ...
            .php(gj.core.formatDate(new Date(), "HH", j.locale))
        ),
        e.append(":"),
        e.append(
          $('<div role="minute" />')
            ...
            .php(gj.core.formatDate(new Date(), "MM", j.locale))
        ),
        g.append(e),
  ...
  (gj.colorpicker.methods = {
    ...
    createPicker: function (a, b) {
      var c = $('<div role="picker" />')
        ...
        .attr("guid", a.attr("data-guid"));
      return c.php("test"), c.hide(), $("body").append(c), c;
    },
    open: function (a) {
      return (
        a.val() && a.value(a.val()),
