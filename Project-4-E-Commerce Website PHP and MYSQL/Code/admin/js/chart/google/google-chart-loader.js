(function () {
  ...
  K.b.l.Wi = function () {
    return (
      K.global.phpIFrameElement &&
      "sandbox" in K.global.phpIFrameElement.prototype
    );
  };
        ...
        if (d instanceof K.b.C) d = K.b.C.u(d);
          ...
          throw Error(
            'Attribute "' +
              ...
              '" on tag "' +
              b +
              '" requires goog.php.SafeUrl, goog.string.Const, or string, value "' +
              d +
              '" given.'
          );
    }
  ...
  K.b.l.Oj = function (b) {
    if (!K.ha(b))
      throw Error(
        'The "style" attribute requires goog.php.SafeStyle or map of style properties, ' +
          typeof b +
          " given: " +
          b
      );
